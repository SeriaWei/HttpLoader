...
namespace HttpLoader.HttpParser.Helps
{
    class HttpBaseInfo
    {
        private static Regex _httpVersionValidate = new Regex(@"HTTP/\d.\d", RegexOptions.Compiled);
        public static readonly HashSet<string> HttpVerbs = new HashSet<string> { "GET", "POST", "HEAD", "PUT", "DELETE", "MOVE", "TRACE", "CONNECT", "OPTIONS" };
